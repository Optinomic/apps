function main(responses) {
    ...
    calc.arrangeScoresInVars = function(current_vars, current_source) {
        ...
        current_vars.gsi_global_severity_index_sum_score.push(current_source.all_results.gsi_global_severity_index_sum_score);
        current_vars.gsi_global_severity_index_scale_score.push(current_source.all_results.gsi_global_severity_index_scale_score);
        current_vars.gsi_global_severity_index_z_score.push(current_source.all_results.gsi_global_severity_index_z_score);
        current_vars.psychotizismus_sum_score.push(current_source.all_results.psychotizismus_sum_score);
        current_vars.psychotizismus_scale_score.push(current_source.all_results.psychotizismus_scale_score);
        current_vars.psychotizismus_z_score.push(current_source.all_results.psychotizismus_z_score);
        current_vars.paranoides_denken_sum_score.push(current_source.all_results.paranoides_denken_sum_score);
        current_vars.paranoides_denken_scale_score.push(current_source.all_results.paranoides_denken_scale_score);
        current_vars.paranoides_denken_z_score.push(current_source.all_results.paranoides_denken_z_score);
        current_vars.phobische_angst_sum_score.push(current_source.all_results.phobische_angst_sum_score);
        current_vars.phobische_angst_scale_score.push(current_source.all_results.phobische_angst_scale_score);
        current_vars.phobische_angst_z_score.push(current_source.all_results.phobische_angst_z_score);
        current_vars.aggressivit__t___feindseligkeit_sum_score.push(current_source.all_results.aggressivit__t___feindseligkeit_sum_score);
        current_vars.aggressivit__t___feindseligkeit_scale_score.push(current_source.all_results.aggressivit__t___feindseligkeit_scale_score);
        current_vars.aggressivit__t___feindseligkeit_z_score.push(current_source.all_results.aggressivit__t___feindseligkeit_z_score);
        current_vars.__ngstlichkeit_sum_score.push(current_source.all_results.__ngstlichkeit_sum_score);
        current_vars.__ngstlichkeit_scale_score.push(current_source.all_results.__ngstlichkeit_scale_score);
        current_vars.__ngstlichkeit_z_score.push(current_source.all_results.__ngstlichkeit_z_score);
        current_vars.depressivit__t_sum_score.push(current_source.all_results.depressivit__t_sum_score);
        current_vars.depressivit__t_scale_score.push(current_source.all_results.depressivit__t_scale_score);
        current_vars.depressivit__t_z_score.push(current_source.all_results.depressivit__t_z_score);
        current_vars.unsicherheit_im_sozialkontakt_sum_score.push(current_source.all_results.unsicherheit_im_sozialkontakt_sum_score);
        current_vars.unsicherheit_im_sozialkontakt_scale_score.push(current_source.all_results.unsicherheit_im_sozialkontakt_scale_score);
        current_vars.unsicherheit_im_sozialkontakt_z_score.push(current_source.all_results.unsicherheit_im_sozialkontakt_z_score);
        current_vars.zwanghaftigkeit_sum_score.push(current_source.all_results.zwanghaftigkeit_sum_score);
        current_vars.zwanghaftigkeit_scale_score.push(current_source.all_results.zwanghaftigkeit_scale_score);
        current_vars.zwanghaftigkeit_z_score.push(current_source.all_results.zwanghaftigkeit_z_score);
        current_vars.somatisierung_sum_score.push(current_source.all_results.somatisierung_sum_score);
        current_vars.somatisierung_scale_score.push(current_source.all_results.somatisierung_scale_score);
        current_vars.somatisierung_z_score.push(current_source.all_results.somatisierung_z_score);
        current_vars.zusatzitems_sum_score.push(current_source.all_results.zusatzitems_sum_score);
        current_vars.zusatzitems_scale_score.push(current_source.all_results.zusatzitems_scale_score);
    ...
    calc.arrangeScoresInDimensions = function(current_source) {
        ...
        var given_mz_group = current_source.info.mz;
        ...
        for (var dIndex = 0; dIndex < return_array.length; dIndex++) {
            ...
            if (dIndex === 0) {
                ...
                if (given_mz_group.mz_typ === 'Eintritt EAS') {
                    cd.dimensions.push(0);
                };

                if (given_mz_group.mz_typ === 'Austritt EP') {
                ...
                if (given_mz_group.mz_typ === 'Austritt EAS') {
                    cd.dimensions.push(3);
                };

                if (given_mz_group.mz_typ === 'Eintritt EP') {
                    cd.dimensions.push(4);
                };

                // Immer in alle Messzeitpunkte
                cd.dimensions.push(5);
