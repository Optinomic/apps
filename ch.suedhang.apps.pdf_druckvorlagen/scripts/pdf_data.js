    ...
    dataPromiseApp.then(function(data) {
        ...
        if (app_identifier === "ch.suedhang.apps.actinfo_ein.production") {
            ...
            if (data.survey_responses.length > 0) {
                ...
                var response = data.survey_responses[last_response_id].entity.data.response;
                ...
                var actinfo_ein_problemsubstanzen_tables = run.actinfo_ein_get_problemsubstanzen_table(data.survey_responses[last_response_id]);
