function main(responses) {
    ...
    calc.getResults = function(myResponses) {
        ...
        responses_array.forEach(function(response, myindex) {
            ...
            // myResults.sum_scores.aggr = 1 + 2 + 3;
            //myResults.sum_scores.aggr = parseInt(BSCL[sq504V06]) + parseInt(BSCL[BSCL_sq504V13]) + parseInt(BSCL[BSCL_sq504V40]) + parseInt(BSCL[BSCL_sq504V46]) + parseInt(BSCL[sq504V06]);
