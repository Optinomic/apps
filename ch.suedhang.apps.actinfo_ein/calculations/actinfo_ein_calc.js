function main(responses) {
    ...
    // Gramm Alkohol berechnen
    calc.get_anz_g_alc = function (drink) {

        var gramm = 0;

        if (d.QZEA120[VZEA120a] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120a])*0.4;
        }
        if (d.QZEA120[VZEA120b] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120b])*0.4;
        }
        if (d.QZEA120[VZEA120c] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120c])*0.4;
        }
        if (d.QZEA120[VZEA120d] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120d])*0.4;
        }
        if (d.QZEA120[VZEA120e] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120e])*0.96;
        }
        if (d.QZEA120[VZEA120f] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120f])*0.96;
        }
        if (d.QZEA120[VZEA120g] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120g])*1.6;
        }
        if (d.QZEA120[VZEA120h] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120h])*1.6;
        }
        if (d.QZEA120[VZEA120i] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120i])*3.2;
        }
        if (d.QZEA120[VZEA120j] !== NULL) {
            gramm = gramm + parseInt(d.QZEA120[VZEA120j])*3.2;
        }
