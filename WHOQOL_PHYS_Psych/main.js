...
app.controller('AppCtrl', function($scope, dataService, scopeDService) {
    ...
    $scope.setCurrentResultDate = function() {
        ...
        var date = $scope.d.dataMain.calculations[0].calculation_results[d.navigator].response.data.filled;
        ...
        console.log('setCurrentResultDate', d.dataMain.calculations[0].calculation_results[$scope.d.navigator].response.data);
