d.bscl_anq = {
    ...
    "fields": [
        ...
        { "name": "datum_erhebung_bscl", "path": "_function", "function": 'var mzp = survey_response.response.q501V04; if (mzp = "1") { return stay.start; } else { if (mzp = "2") { return stay.stop; } else { return survey_response.response.q504V00; }; };'},
