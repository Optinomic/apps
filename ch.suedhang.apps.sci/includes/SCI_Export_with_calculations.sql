SELECT
  ...
  cast(calc.value as json)->0#>>'{scores, 0,  stanine}' as stanine_score_belastung,
  cast(calc.value as json)->0#>>'{scores, 1,  stanine}' as stanine_score_stress,
  cast(calc.value as json)->0#>>'{scores, 2,  stanine}' as stanine_score_positives_denken,
  cast(calc.value as json)->0#>>'{scores, 3,  stanine}' as stanine_score_stessbewaeltigung,
  cast(calc.value as json)->0#>>'{scores, 4,  stanine}' as stanine_score_soz_unterstuetzung,
  cast(calc.value as json)->0#>>'{scores, 5,  stanine}' as stanine_score_glauben,
  cast(calc.value as json)->0#>>'{scores, 6,  stanine}' as stanine_score_alkohol,
...
WHERE survey_response_view.module = 'ch.suedhang.apps.sci';
