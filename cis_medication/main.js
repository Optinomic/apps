        ...
        api_call.then(function(data) {
            ...
            if (dataService.isEmpty(data)) {
                ...
                $scope.d.medication.forEach(function(row, myindex) {
                    ...
                    row.medication_status_bezeichnung = '?';
                    $scope.d.appInit.medication_status.forEach(function(status, myindex) {
                        if (status.id === parseInt(row.medication_status)) {
                            row.medication_status_bezeichnung = status.title;
                        };
                    });
