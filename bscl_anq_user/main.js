...
app.controller('AppCtrl', function($scope, simpleStatistics, dataService, scopeDService) {
    ...
    $scope.loadMainData = function() {
        ...
        dataPromiseMain.then(function(data) {
            ...
            $scope.my_groups = $scope.createGroups(all_results);
            //$scope.my_calculations = $scope.calculateGroups($scope.my_groups)
            $scope.setTscoreChart();
            $scope.my_calculations = [];
            console.log('(!) ', $scope.my_groups, $scope.my_calculations);
