function main(data) {
    ...
    calc.prepare = function(my_data) {
        ...
        var return_data = {};
        my_data.forEach(function(calculation, myindex) {
            return_data.all = [];

            if (calculation.calculation_name === 'get_all_results') {
                var all_responses = calculation.calculation_results.responses;

                var responses_prepared = [];
