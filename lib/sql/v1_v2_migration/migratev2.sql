update event set module = 'ch.suedhang.apps.bscl_anq.production' where module = '12';
update survey_response set module = 'ch.suedhang.apps.bscl_anq.production' where module = '12';
update patient_uses_module set module = 'ch.suedhang.apps.bscl_anq.production' where module = '12';

update event set module = 'ch.suedhang.apps.zuepaz.production' where module = '26';
update survey_response set module = 'ch.suedhang.apps.zuepaz.production' where module = '26';
update patient_uses_module set module = 'ch.suedhang.apps.zuepaz.production' where module = '26';

update event set module = 'ch.suedhang.apps.neuroanamnese.production' where module = '28';
update survey_response set module = 'ch.suedhang.apps.neuroanamnese.production' where module = '28';
update patient_uses_module set module = 'ch.suedhang.apps.neuroanamnese.production' where module = '28';

update event set module = 'ch.suedhang.apps.honos.production' where module = '16';
update survey_response set module = 'ch.suedhang.apps.honos.production' where module = '16';
update patient_uses_module set module = 'ch.suedhang.apps.honos.production' where module = '16';

update event set module = 'ch.suedhang.apps.case.production' where module = '24';
update survey_response set module = 'ch.suedhang.apps.case.production' where module = '24';
update patient_uses_module set module = 'ch.suedhang.apps.case.production' where module = '24';

update event set module = 'ch.suedhang.apps.whoqol.production' where module = '4';
update survey_response set module = 'ch.suedhang.apps.whoqol.production' where module = '4';
update patient_uses_module set module = 'ch.suedhang.apps.whoqol.production' where module = '4';

update event set module = 'ch.suedhang.apps.actinfo_aus.production' where module = '10';
update survey_response set module = 'ch.suedhang.apps.actinfo_aus.production' where module = '10';
update patient_uses_module set module = 'ch.suedhang.apps.actinfo_aus.production' where module = '10';

update event set module = 'ch.suedhang.apps.tmt.production' where module = '13';
update survey_response set module = 'ch.suedhang.apps.tmt.production' where module = '13';
update patient_uses_module set module = 'ch.suedhang.apps.tmt.production' where module = '13';

update event set module = 'ch.suedhang.apps.case.production' where module = '15';
update survey_response set module = 'ch.suedhang.apps.case.production' where module = '15';
update patient_uses_module set module = 'ch.suedhang.apps.case.production' where module = '15';

update event set module = 'ch.suedhang.apps.bdi.production' where module = '3';
update survey_response set module = 'ch.suedhang.apps.bdi.production' where module = '3';
update patient_uses_module set module = 'ch.suedhang.apps.bdi.production' where module = '3';

update event set module = 'ch.suedhang.apps.isk.production' where module = '2';
update survey_response set module = 'ch.suedhang.apps.isk.production' where module = '2';
update patient_uses_module set module = 'ch.suedhang.apps.isk.production' where module = '2';

update event set module = 'ch.suedhang.apps.sci.production'  where module = '5';
update survey_response set module = 'ch.suedhang.apps.sci.production'  where module = '5';
update patient_uses_module set module = 'ch.suedhang.apps.sci.production'  where module = '5';

update event set module = 'ch.suedhang.apps.aase-g.production' where module = '8';
update survey_response set module = 'ch.suedhang.apps.aase-g.production' where module = '8';
update patient_uses_module set module = 'ch.suedhang.apps.aase-g.production' where module = '8';

update event set module = 'ch.suedhang.apps.actinfo_ein.production' where module = '9';
update survey_response set module = 'ch.suedhang.apps.actinfo_ein.production' where module = '9';
update patient_uses_module set module = 'ch.suedhang.apps.actinfo_ein.production' where module = '9';

update event set module = 'ch.suedhang.apps.tmt.production' where module = '25';
update survey_response set module = 'ch.suedhang.apps.tmt.production' where module = '25';
update patient_uses_module set module = 'ch.suedhang.apps.tmt.production' where module = '25';
...
UPDATE "survey_response" 
SET response = regexp_replace(response, 'H1_(\w+)', 'H1[\1]', 'g') 
WHERE module = 'ch.suedhang.apps.honos.production';
UPDATE "survey_response" 
SET response = regexp_replace(response, 'H2_(\w+)', 'H2[\1]', 'g') 
WHERE module = 'ch.suedhang.apps.honos.production';

insert into event (patient, responsibility_nobody, module, survey_name, random_hash, due, done, overdue, description, created_at) select sr.patient, 't', sr.module, 'fake-survey', sr.random_hash, sr.filled, 'EventStatusDone', 'OverdueIgnore', 'Fake event for migration to V2', sr.scheduled from survey_response as sr left join event on event.random_hash = sr.random_hash where event.id is null and char_length(sr.module) > 16;

update event set url = '#' where url is null;

update event set responsibility_nobody = 't' where responsibility_user is null and responsibility_role is null and responsibility_patient_via_email = 'f' and responsibility_patient_via_assessment = 'f' and responsibility_deputy is null;
