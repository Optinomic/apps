...
createStayExtras = function(current_stay) {
    ...
    if (current_stay.stop) {
        ...
        current_stay.extras.duration = current_stay.duration + 2; //incl. start & stop date
    } else {
    ...
    current_stay.extras.from_to = current_stay.from_to + ' - ';
    if (current_stay.stop) {
        current_stay.extras.from_to = current_stay.extras.from_to + formatDateCH(current_stay.stop);
        current_stay.extras.ende = formatDateCH(current_stay.start);
    } else {
