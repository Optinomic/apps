    ...
    actions: {
        ...
        actionLoginKomed: function() {
            return function(dispatch) {
                ...
                //const api_url = 'https://optinomic.komed-health.com/account/login';
                const api_url = 'https://optinomic.komed-health.com/account/login';
                // Do async task
                ...
                xhttp.onreadystatechange = function() {
                    if ((xhttp.status == 200) && (xhttp.readyState == 4)) {
                        ...
                        xhttp2.open("GET", "https://optinomic.komed-health.com/rooms", true);
                ...
                helpers.callAPI('GET', api_url, {}, {}, function(req) {
                    if (req.status == 200) {
                        ...
                        resp.survey_responses.forEach(function(current_response, srID) {
                            ...
                            console.log('resp.calculations', resp.calculations);
                            resp.calculations.value.forEach(function(current_calculation, calculationID) {
                                ...
                                if ("response" in current_calculation) {
                                    if ("data" in current_result.response) {
                                        if ("response" in current_result.response.data) {
