const AsyncActionsBehavior = {
    actions: {
                ...
                helpers.callAPI('GET', api_url, {}, {}, function(req) {
                    ...
                    if (req.status == 200) {
                        ...
                        resp.survey_responses.forEach(function(current_response, srID) {
                                ...
                                current_calculation_top.value.forEach(function(current_calculation, calculationID) {
                                    ...
                                    if (variant_info) {
                                        ...
                                        if (JSON.stringify(calc_resp) === JSON.stringify(return_obj.response)) {
                                            ...
                                            return_obj.calculation = Object.assign(return_obj.calculation, current_calculation);
                                        };
                                    };
                            ...
                            // Return all calculations (always).
        ...
        actionGetSurveyResponsesNew: function(requested_app_id) {

            return function(dispatch) {

                module_identifier = requested_app_id === undefined ? helpers.getAppID() : requested_app_id;
                console.log('(?) actionGetSurveyResponsesNew', module_identifier);
                ...
                helpers.callAPI('GET', api_url, {}, {}, function(req) {
                    ...
                    if (req.status == 200) {
                        var resp = JSON.parse(req.response);
                        console.log('actionGetSurveyResponsesNew:: resp', resp);
                        ...
                        helpers.callAPI('GET', calculation_results_api_url, {}, {}, function(inner_req) {
                            ...
                            if (req.status == 200) {
                                ...
                                resp.survey_responses.forEach(function(current_response, srID) {
                                    ...
                                    // Return all calculations (always).
                                    return_obj.calculation_results = calculation_results;
                                ...
                                console.log('INNER 1 :: actionGetSurveyResponsesNew:: resp', inner_resp);
                                console.log('INNER 2 :: actionGetSurveyResponsesNew:: resp', resp);
