                                        ...
                                        if (JSON.stringify(calc_resp) === JSON.stringify(return_obj.response)) {
                                            ...
                                            if ("TMTAError" in calc_resp) {
                                                ...
                                                if ((parseInt(calc_resp.TMTAError) === parseInt(return_obj.response.TMTAError)) &&
                                                    ...
                                                    console.error('1 NOT FOUND ::', parseInt(calc_resp.TMTAError), parseInt(return_obj.response.TMTAError));
                                                    console.error('2 NOT FOUND ::', parseInt(calc_resp.TMTATime), parseInt(return_obj.response.TMTATime));
                                                    console.error('3 NOT FOUND ::', parseInt(calc_resp.Ausbildungsjahre), parseInt(return_obj.response.Ausbildungsjahre));
                                                    console.error('4 NOT FOUND ::', parseInt(calc_resp.Messzeitpunkt), parseInt(return_obj.response.Messzeitpunkt));
                                                };
