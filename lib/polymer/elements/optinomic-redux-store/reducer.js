const reducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case 'GET_SURVEY_RESPONSES_STARTED':
            console.log('(?) GET_SURVEY_RESPONSES_STARTED', action, state);

            return Object.assign({}, state, {
                loading: true,
                survey_responses_current_loading: action.app_id
            });
        ...
        case 'GET_SURVEY_RESPONSES_COMPLETE':
            ...
            var app_id = state.survey_responses_current_loading;
            sr[app_id] = action.data;
            console.log('GET_SURVEY_RESPONSES_COMPLETE', sr, action);
            return Object.assign({}, state, {
                loading: false,
                survey_responses: sr,
                survey_responses_current_loading: ""
            });
