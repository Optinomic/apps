const reducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case 'GET_USERAPPCALCULATION_COMPLETE':
            ...
            var module_identifier = action.module_identifier.split('.').join('_');
            var calculation_identifier = action.calculation_identifier;
            var name = module_identifier + "___" + calculation_identifier;

            _app_userapp_calculations[action.name] = action.data; 
