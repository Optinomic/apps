angular.module('optinomicDataModule').factory('apiService', function($http, config) {
    ...
    var post = function(path, query, body) {
        return request("POST", path, query, body);
    };

    var put = function(path, query, body) {
    ...
    var patch = function(path, query, body) {
