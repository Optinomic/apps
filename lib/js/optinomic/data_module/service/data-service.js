...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, $rootElement, $location, apiService) {
        ...
        dataService.getMainAppData = function() {
            ...
            //return_data.params.view = $location.pathname.substring($location.pathname.lastIndexOf("/") + 1);
            return_data.params.url = $location.url();
            return_data.params.path = $location.path();
