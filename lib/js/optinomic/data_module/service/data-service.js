...
angular.module('optinomicDataModule')
    .service('dataService', function($q, apiService, config) {
        ...
        dataService.getCurrentPatient = function() {
            return apiService.get("/patients/" + dataService.getPatientID() + "/full", {});
        };
        ...
        dataService.getMainAppData = function(app_identifier) {
            ...
            aConfig.then(function(data) {
                ...
                return_data.config.api.url = config.apiUrl;
