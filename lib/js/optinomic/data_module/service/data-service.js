    ...
    .service('dataService', function($q, $filter, apiService) {
        ...
        dataService.saveAnnotationsData = function(api_direction, node_tree, json_value) {
            ...
            aPromise.then(function(current_data) {
                ...
                // Save a 'save stamp'
                full_data[node_tree].save_stamp = {};
                full_data[node_tree].save_stamp.getPatientID = dataService.getPatientID();
                full_data[node_tree].save_stamp.getAppName = dataService.getAppName();
                full_data[node_tree].save_stamp.getAppID = dataService.getAppID();
                full_data[node_tree].save_stamp.getApiURL = dataService.getApiURL();
                full_data[node_tree].save_stamp.getUserID = dataService.getUserID();
                full_data[node_tree].save_stamp.getStayID = dataService.getStayID();

                var date = new Date();
                full_data[node_tree].save_stamp.date = {
