...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, apiService) {
        ...
        dataService.getAppCalculationsUser = function(module_identifier, calculation_identifier) {
            return apiService.get("/calculations/" + module_identifier + "/" + calculation_identifier, {});
        };
