                ...
                aPromise.then(function(data) {
                        ...
                        if (return_data.length > 0) {
                            return_data.forEach(function(item, myindex) {
                                    ...
                                    if ((item.stay === stay_id) || (stay_id === NaN) || (stay_id === null) {
                                            console.log('(Pushed) ---> ', item, myindex);
                                            return_array.push(item.data);
                                        };
                                    });
                            };

                            console.log('(!) getAnnotationsData - Return - Array', return_array);
                            deferred.resolve(return_array[0]);
