...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, $window, apiService) {
        ...
        dataService.getSurveyResponses = function(stay_id, app_identifier) {
            ...
            app_identifier = app_identifier === NaN ? helpers.getAppID() : app_identifier;
        ...
        dataService.getAppCalculations = function(my_module_identifier, calculation_identifier) {
            return apiService.get("/patients/" + helpers.getPatientID() + "/calculations/" + my_module_identifier + "/" + calculation_identifier, {});
        };
                    ...
                    if (current_app.identifier === app_identifier) {
                        ...
                        current_app.calculations.forEach(function(calculatons, myindex) {
                            ...
                            if (parseInt(helpers.getPatientID()) === 0) {
                                ...
                                api = dataService.getAppCalculations(current_app.identifier, calculatons);
                            };
