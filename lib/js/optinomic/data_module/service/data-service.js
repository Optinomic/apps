...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, apiService) {
        ...
        dataService.createUserExtras = function(user) {
            ...
            $translate(user.gender).then(function(translated) {
                user.extras.ansprache = translated;
            });
            ...
            $translate(user.role).then(function(translated) {
                user.extras.infoline = translated + ' - ' + user.description;
            });
        ...
        dataService.putPatientAnnotationsData = function(node_tree, json_value) {
            ...
            mySettings.then(function(current_data) {
                ...
                var api = dataService.putPatientAnnotations(full_settings);
                var aPromise = dataService.getData(api);
