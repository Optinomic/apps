    ...
    .service('dataService', function($q, $filter, $window, apiService) {
        ...
        dataService.createStayExtras = function(current_pid, current_stay) {
            ...
            if (current_stay.data.stop) {
                ...
                $translate('Unknown').then(function(translated) {
                    current_stay.from_to = current_stay.from_to + translated;
                });
            }
            ...
            if (current_stay.data.lead_therapist_id_overwrite) {
                userService.getUser(current_stay.data.lead_therapist_id_overwrite).success(function(data) {
                    current_stay.team.lead_therapist = data.user;
                });
            } else {
                if (current_stay.data.lead_therapist_id) {
                    userService.getUser(current_stay.data.lead_therapist_id).success(function(data) {
                        current_stay.team.lead_therapist = data.user;
                    });
                };
            };
            ...
            if (current_stay.data.deputy_lead_therapist_id) {
                userService.getUser(current_stay.data.deputy_lead_therapist_id).success(function(data) {
                    current_stay.team.lead_therapist_deputy = data.user;
                });
            };

            if (current_stay.data.cis_lead_doctor) {
                userService.getUser(current_stay.data.cis_lead_doctor).success(function(data) {
