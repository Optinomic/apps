        ...
        dataService.getMainAppData = function() {
            ...
            aSurveyResponses.then(function(data) {
                ...
                return_data.survey_responses_group.forEach(function(current_group, myindex) {
                    ...
                    return_data.survey_responses_group[myindex].push(myObject);
                    console.log('(!) - survey_responses_group', current_group, return_data.survey_responses_group);
                });
                ...
                //
                //
                //    survey_responses_array.push(response.entity.data.response)
                //
                //    survey_responses_arrays[response.event.survey_name] = {
                //        'survey': response.event.survey_name,
                //        'data': survey_responses_array
                //
                //    };
                //
                //
                //    //survey_responses_arrays[response.event.survey_name] = [];
                //    //survey_responses_arrays[response.event.survey_name].push(response.entity.data.response);
                //});
                //
                //return_data.survey_responses = responses;
                //return_data.survey_responses_arrays = survey_responses_arrays;
                //return_data.survey_responses_array = [];
