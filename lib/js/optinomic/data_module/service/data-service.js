                        ...
                        current_app.calculations.forEach(function(calculatons, myindex) {
                            ...
                            aCalculation.then(function(data) {
                                ...
                                return_data.survey_responses.forEach(function(response, myindex) {
                                    console.log('(+) LOOP - survey_responses: ', response, myindex);

                                    var all_results = data.calculation_result
                                    all_results.forEach(function(current_result, myindex) {
                                        console.log('(+) Compare: ', current_result.response, response.data.response);

                                        if (current_result.response.data.response === response.data.response) {
                                            console.log('(+) EQUAL: ', current_result.response, response.data.response);
                                            ...
                                            response.calculations = objectToPush;
                                        };
                                    });
