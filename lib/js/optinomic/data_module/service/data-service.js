...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, apiService) {
        ...
        dataService.putUserAnnotationsData = function(node_tree, json_value) {

            var deferred = $q.defer();
            var return_data = {};
            var full_settings = {};

            console.log('(?) putUserAnnotationsData START', json_value);
            ...
            mySettings.then(function(current_data) {
                ...
                console.log('(?) putUserAnnotationsData', current_data, full_settings);
