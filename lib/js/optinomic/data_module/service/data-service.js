...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, apiService) {
        ...
        dataService.saveAnnotationsData = function(app_id, node_tree, json_value) {
            ...
            aPromise.then(function(current_data) {
                ...
                aPromise.then(function(data) {
                    ...
                    console.log('(!) saveAnnotationsData - Success', return_data);
                    deferred.resolve(return_data);
        ...
        dataService.getPatientAnnotationsData = function(app_id, node_tree) {
            var deferred = $q.defer();
            var return_data = {};
        ...
        dataService.putPatientAnnotationsData = function(app_id, node_tree, json_value) {
            ...
            mySettings.then(function(current_data) {
                ...
                // Save and proceed.
                var api = dataService.putPatientAnnotations(JSON.stringify(full_data));
                var aPromise = dataService.getData(api);
