...
angular.module('optinomicDataModule')
    .service('dataService', function($q, $filter, apiService) {
        ...
        dataService.saveAnnotationsData = function(api_direction, node_tree, json_value) {
            ...
            json_value.save_stamp = {};
            json_value.save_stamp.getPatientID = dataService.getPatientID();
            json_value.save_stamp.getAppName = dataService.getAppName();
            json_value.save_stamp.getAppID = dataService.getAppID();
            json_value.save_stamp.getApiURL = dataService.getApiURL();
            json_value.save_stamp.getUserID = dataService.getUserID();
            json_value.save_stamp.getStayID = dataService.getStayID();

            var date = new Date();
            json_value.save_stamp.date = {
