...
angular.module('optinomicDataModule')
    .service('scopeDService', function() {
        ...
        scopeDService.grid.default_options = {
            headerHeight: 50,
            rowHeight: 28,
            rowData: [],
            columnDefs: [],
            ...
            onReady: function(event) {
                ...
                scopeDService._init.grid.grid_ready = true;
            },
            ...
            onRowSelected: function(event) {
                ...
                if (event.node.data === $scope.d.grid.selected_row) {
                    scopeDService.grid.selected_row = null;
                    scopeDService.grid.is_row_selected = false;
                    scopeDService.grid.options.api.deselectAll();
                } else {
                    scopeDService.grid.selected_row = event.node.data;
                    scopeDService.grid.is_row_selected = true;
                };
