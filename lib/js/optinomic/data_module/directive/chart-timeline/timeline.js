...
angular.module('optinomicDataModule')
    .directive('chartTimeline', function($filter, simpleStatistics) {
        return {
            ...
            template: '' +
                '<canvas height="{{myOptions.screenHeight}}" width="{{myOptions.screenWidth}}" id="weekday" class="chart chart-line" data="dateCharts.weekday.data" labels="dateCharts.weekday.labels" series="dateCharts.weekday.series" legend="true"></canvas>',
            restrict: 'E',
            //replace: true,
            //transclude: true,
            scope: {
