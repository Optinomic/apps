...
angular.module('optinomicDataModule')
    .directive('chartTimeline', function($filter, $sce, simpleStatistics) {
        return {
            //templateUrl: '/lib/js/optinomic/data_module/directive/chart-timeline/timeline.html',
            //templateUrl: '../lib/js/optinomic/data_module/directive/chart-timeline/timeline.html',
            templateUrl: '$sce.getTrustedResourceUrl("https://rawgit.com/Optinomic/apps/master/lib/js/optinomic/data_module/directive/chart-timeline/timeline.html")',
            //template: 'chartTimeline directive works: {{data.length}}',
            restrict: 'E',
            //replace: true,
            //transclude: true,
            scope: {
            ...
            link: function postLink(scope, element, attrs) {
                ...
                scope.myURL = $sce.getTrustedResourceUrl('https://rawgit.com/Optinomic/apps/master/lib/js/optinomic/data_module/directive/chart-timeline/timeline.html');
                ...
                function updateStuff() {
                    ...
                    //console.log('chartTimeline: result_data', scope.result_data, scope.result_data.length);
                ...
                function GroupResults(array) {
                    ...
                    var array_sort_weekday = sortByKey(array, 'date_weekday');

                    resultsGrouped.weekday = groupBy(array_sort_weekday, function(item) {
                        return [item.date_info.date_weekday];
                    });

                    var array_sort_quarter = sortByKey(array, 'date_quarter');
