...
angular.module('optinomicDataModule')
    .directive('chartTscore', function(simpleStatistics) {
        ...
        return {
            ...
            templateUrl: 'https://rawgit.com/Optinomic/apps/master/lib/js/optinomic/data_module/directive/chart-tscore/tscore.html?V20151008',
                ...
                function preparePlot(data) {
                    ...
                    if (scope.data.length > 1) {
                        ...
                        for (var x in allScores) {
                            ...
                            calcMean = calcMean.toFixed(1); //Round to 1 Decimal-place
