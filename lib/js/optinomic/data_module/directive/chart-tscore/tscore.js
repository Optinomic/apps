...
angular.module('optinomicDataModule')
    .directive('chartTscore', function(simpleStatistics) {
        ...
        return {
            ...
            templateUrl: 'https://cdn.rawgit.com/Optinomic/apps/master/lib/js/optinomic/data_module/directive/chart-tscore/tscore.html?v20150901',
            ...
            link: function postLink(scope, element, attrs) {
                ...
                function updateStuff() {
                    ...
                    scope.plot = addMeanPlot(scope.plot);
                ...
                function preparePlot(data) {
                    ...
                    var meanAnswer = {
                        "label": 'Mean',
                        "t_scores": [],
                        "colour": getColor(data.length + 1)
                    };

                    for (var x in allScores) {
                        var currentScore = allScores[x];
                        var calcMean = simpleStatistics.mean(currentScore);
                        meanAnswer.t_scores.push(calcMean);
                    };

                    console.log('Starting Array for Statistics: ', allScores, meanAnswer);
