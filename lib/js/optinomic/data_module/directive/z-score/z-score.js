angular.module('optinomic').directive('zScore', function() {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
        ...
        templateUrl: 'https://cdn.rawgit.com/Optinomic/apps/master/lib/js/optinomic/data_module/directive/z-score/z-score-v1.html',
