angular.module('optinomicDataModule').directive('zScore', function() {
    return {
        ...
        templateUrl: 'https://cdn.rawgit.com/Optinomic/apps/master/lib/js/optinomic/data_module/directive/z-score/rawgit/z-score-v9.html',
        ...
        link: function(scope, element, attrs, ngModel) {
            ...
            function just_do_it() {
                ...
                if (scope.data.clinicsample_color !== undefined) {
                    console.log('(new) clinicsample_color', scope.options.clinicsample_color);
                    scope.options.clinicsample_color = scope.data.clinicsample_color
                } else {
