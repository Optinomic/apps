        ...
        surveyResults.forEach(function(result) {
            ...
            for (var property in result) {
                if (result.hasOwnProperty(property)) {
                    // do stuff
                    console.log('createDataView :: ', property);
                    ...
                    if (editable) {
                        line.newValueHandler = editValueHandler;
                    };

                    // Handle some known special properties
                    if ((property === 'PID') || (property === 'FID') || (property === 'id')) {
                        line.width = 110;
                    ...
                    if ((property === 'optinomixHASH') || (property === 'ipaddr') || (property === 'refurl')) {
                        line.width = 110;
                        line.hide = true;
                    };
