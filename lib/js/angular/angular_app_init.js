...
angular.module('optinomicDataModule').config(function($mdThemingProvider, $mdDateLocaleProvider) {
    ...
    //$mdDateLocaleProvider.shortMonths = ['Jan', 'Feb', 'Mär', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sept', 'Okt', 'Nov', 'Dez'];
    ...
    //console.log('$mdDateLocaleProvider', $mdDateLocaleProvider);
...
angular.module('optinomicDataModule').controller('MainCtrl', function($scope, $q, $filter, $mdToast, $window, apiService, dataService, scopeDService, simpleStatistics) {
    ...
    $scope.d.functions.getDefaultExportSettings = function(app_id, app_packages) {
        ...
        api.success(function(data) {
            ...
            var data_package = {};
            data_package = {
                name: 'Response (full) | all Patients',
                sql: enhanced_query
            };
            sql_box.packages.push(data_package);
            ...
            patient_query = patient_query.replace(";", current_patient_where);
            data_package = {
                name: 'Response (full) | ' + current_patient_name,
                sql: patient_query
            };
            sql_box.packages.push(data_package);
