...
angular.module('optinomicDataModule').controller('MainCtrl', function($scope, $filter, $mdToast, $window, apiService, dataService, scopeDService, simpleStatistics) {
    ...
    $scope.d.functions.visa = function(email, password) {
        ...
        apiService.post("/signin", {
            ...
            .success(function(data) {
                ...
                console.log('(+) visa: success', return_object);
                ...
                console.log('(-) visa: error', return_object);
                return return_object
            });
