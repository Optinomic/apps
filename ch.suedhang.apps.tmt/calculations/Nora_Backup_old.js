function main(responses) {
    ...
    var TMTAError = parseInt({
        { d.dataMain.survey_responses[0].entity.data.response.TMTAError } });
    var TMTBError = parseInt({
        { d.dataMain.survey_responses[0].entity.data.response.TMTBError } });
    var TMTATime = parseInt({
        { d.dataMain.survey_responses[0].entity.data.response.TMTATime } });
    var TMTBTime = parseInt({
        { d.dataMain.survey_responses[0].entity.data.response.TMTBTime } });
