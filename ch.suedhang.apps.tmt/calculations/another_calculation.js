function main(responses) {
    ...
    calc.getPatientAge = function(birth_date) {
        ...
        return age;
            ...
            var TMTAError = parseInt({{d.dataMain.survey_responses[0].entity.data.response.TMTAError}});
            var TMTBError = parseInt({{d.dataMain.survey_responses[0].entity.data.response.TMTBError}});
            var TMTATime = parseInt({{d.dataMain.survey_responses[0].entity.data.response.TMTATime}});
            var TMTBTime = parseInt({{d.dataMain.survey_responses[0].entity.data.response.TMTBTime}});
    ...
    calc.getResults = function(myResponses) {
        ...
        responses_array.forEach(function(response, myindex) {
            ...
            // calculate stuff
            var set_age = calc.getPatientAge (myResponses.patient.data.birthdate);
            var edu_years = calc.roundToTwo (response.data.response.Ausbildungsjahre);
            var quotient = calc.quotient (result)
