...
app.controller('AppCtrl', function($scope, $filter, dataService, scopeDService) {
    ...
    $scope.setDataView = function() {
        ...
        $scope.d.dataMain.survey_responses_group[currentResultGroup].forEach(function(current_result, myindex) {
            ...
            my_response.display = 'AUS: ' + my_response.aus_item_01 + ', ' + my_response.aus_item_02 + ', ' + my_response.aus_item_03 + ', ' + my_response.aus_item_04 + ', ' + my_response.aus_item_05 + ', ' + my_response.aus_item_06 + ', ' + my_response.aus_item_07
